      ...
      <div className="relative min-h-[70vh]">
        ...
        <div className="relative z-10 flex min-h-[70vh] flex-col items-center justify-center px-6 py-20 text-center">
          ...
          >
            ...
            <h2 className="mb-8 font-sans text-3xl font-bold leading-tight text-[#1A1A1A] md:text-5xl lg:text-6xl">
            ...
            <p className="mb-6 font-mono text-sm leading-relaxed text-[#1A1A1A]/80 md:text-base">
            ...
            <p className="font-mono text-sm leading-relaxed text-[#1A1A1A]/80 md:text-base">
            ...
            <div className="mt-12 grid grid-cols-3 gap-8">
              <div>
                ...
                <p className="mt-1 font-mono text-xs uppercase tracking-wider text-[#1A1A1A]/50">
                  Veg Dishes
                </p>
              </div>
              <div>
