    ...
    <section id="home" className="relative min-h-screen overflow-hidden">
      ...
      <div className="relative z-10 flex min-h-screen flex-col items-center justify-center px-6 text-center">
        ...
        >
          ...
          <p className="mb-2 font-sans text-2xl font-light text-white/80 md:text-3xl">
          ...
          {/* Sub text */}
          <p className="mx-auto mb-10 max-w-2xl font-mono text-sm leading-relaxed text-white/70 md:text-base">
...
function StatItem({ 
  ...
  return (
    <div className="flex flex-col items-center px-4 py-2">
      ...
      <span className="mt-1 font-mono text-xs uppercase tracking-wider text-white/60">
        {stat.label}
      </span>
    </div>
  )
